<p>In this Spring boot project we generate a QR Code. These days people are frequently using the QR Code to transfer the money to their relatives and friends.
