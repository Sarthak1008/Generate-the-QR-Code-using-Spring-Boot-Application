package com.example.Generate.the.QR.Code.using.Spring.Boot.Application.service;
...
public class QRGenerator {
     ...
     * In the above class, we have defined two methods, the first method is used to
